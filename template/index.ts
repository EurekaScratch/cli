import { ScratchExtensionClass } from './typings/extension-metadata';
import icon from './assets/icon.svg';

class MyExtension implements ScratchExtensionClass {
  /**
  ...
  getInfo () {
    return {
      ...
      name: 'Cool Extension',
      //`blockIconURI`` is the image to be placed on each block in this extension.
      blockIconURI: icon,
      blocks: [
        {
